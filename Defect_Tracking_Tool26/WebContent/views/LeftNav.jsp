            ...
            <div class="scroll-sidebar">
                ...
                <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="mdi mdi-settings"></i><span class="hide-menu">Settings </span></a>
                	 <ul  aria-expanded="false" class="collapse  first-level">
                         ...
                         <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="AssignProject.jsp" aria-expanded="false"><i class="mdi mdi-file"></i><span class="hide-menu">Add Project</span></a></li>
