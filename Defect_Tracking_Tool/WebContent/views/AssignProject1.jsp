...
<body>
	...
	<div id="main-wrapper">
								...
								<fieldset  class="col-sm-10">
									...
									<!--  	<label for="ProjectName"
										...
										<div class="col-md-5">
											...
											<div>
													<button class="btn btn-md btn-warning"  style="background-color: darkmagenta" data-toggle="modal" data-target="#userid">
		...
		<!-- End Wrapper -->
		<!-- ============================================================== -->
			<div id="userid" class="modal fade" role="dialog">
							...
							<form action="../AddUser_Action" method="post">
								<fieldset class="col-sm-12">
									...
									<div class="form-group row">
										...
										<div class="col-sm-8">
											<input type="email" class="form-control" id="UserEmail2"
												placeholder="EMAIL" name="email" 
												onkeyup="ValidateEmail2()"	required> 
