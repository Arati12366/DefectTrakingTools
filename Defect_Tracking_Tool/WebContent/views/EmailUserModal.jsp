...
<div class="modal-content">
        ...
        <fieldset class="col-sm-12">
      	<legend class="legend_border col-sm-4"  style="padding-right:4px; background:#2471a3;">User Mail</legend>
        <% 
        ...
        else
        {
        	...
        	%>
        		...
        		<div class=" text-right col-sm-7 "><i><label for="email">VERTICAL SOFTWARE PVT. LTD.</label></i></div>
        			<div class="form-group row text-right ">
        			<input type="hidden"  name="from" class="form-control " value="vertical.webmail@gmail.com" disabled>
        			</div>
        			</div>
        		...
        		<div class="from-group row">
        			...
        			<input type="email"  name="to" class="form-control" onkeypress=" return updateEmail(event)" disabled="disabled" id="uemail" value="<%=rb.getEmail()%>"  required>
           			</div>
           			
           			<div class="col-md-2">
					<button class="btn btn-warning  btn-xs mdi mdi-grease-pencil" id="bemail"    >
					</button>
					</div>
					</div>
				<br>
        		...
        		<label for="orgName" class=" text-left control-label col-form-label">Text</label><br>
        		 ...
        		 <div class="form-group row">
               	...
               	<div class="form-group row" >
					<div class="col-md-6">
						<button class="btn btn-success btn-md float-right" style="border-radius: 12px" type="submit"
