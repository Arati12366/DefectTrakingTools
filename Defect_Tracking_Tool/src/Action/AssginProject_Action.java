...
public class AssginProject_Action extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.println("hi in project");
		
	////response.sendRedirect("views/AssignProject1.jsp");
			RequestDispatcher rb= request.getRequestDispatcher("views/AssignProject1.jsp");
